...
append :linked_dirs, "log", "tmp/pids", "tmp/cache", "tmp/sockets", "public/system", "public/assets", "public/img"
 
set :keep_releases, 5
set :migration_role, :app

set :ssh_options, { forward_agent: true, user: fetch(:user), keys: %w(/code/key/zarabarbosa.pem) }
