...
Setting.create!(email: "exemplo@exemplo.com.br", phone: "(84) 99629 1483", facebook: "", instagram: "", twitter: "", linkedin: "", picture: File.new(Rails.root.join('public', 'settings', 'logo_header.png'), 'r'), picture_footer: File.new(Rails.root.join('public', 'settings', 'logo_footer.png'), 'r'))
